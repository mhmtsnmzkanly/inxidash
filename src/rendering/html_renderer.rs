...
<body theme="default">
  <app class="app-shell">
    ...
    <footer class="container text-sm text-muted py-8 text-center border-t">
      ...
      <p class="mb-2 text-xs opacity-75">Powered by <a href="https://github.com/aiedrow/Melt" class="text-muted" target="_blank">Melt UI</a> · Icons from <a href="https://www.flaticon.com/" class="text-muted" target="_blank">Flaticon</a></p>
...
<body theme="default">
  <app class="app-shell">
    ...
    <footer class="container text-sm text-muted py-8 text-center border-t">
      ...
      <p class="mb-0 text-xs opacity-75">Powered by <a href="https://github.com/aiedrow/Melt" class="text-muted" target="_blank">Melt UI</a> · Icons from <a href="https://www.flaticon.com/" class="text-muted" target="_blank">Flaticon</a></p>
    </footer>
  </app>
  <script>{js}</script>
</body>
